...
from utils.loss_utils import l1_loss, ssim, loss_cosine_similarity_3d4
...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from):
    ...
    # writer.writerow(['regu_loss', 'L1', 'SSIM'])
    ...
    # cls_criterion = torch.nn.CrossEntropyLoss(reduction='none')  # 交叉熵计算器
    ...
    for iteration in range(first_iter, 7001):
        ...
        # if iteration % 50 == 0:
        regu_loss = loss_cosine_similarity_3d4(gaussians.get_features)
        # writer.writerow((regu_loss, Ll1, ssim_loss))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_iterations", nargs="+", type=int, default=[2_000, 7_000])
    parser.add_argument("--save_iterations", nargs="+", type=int, default=[2_000, 7_000])
